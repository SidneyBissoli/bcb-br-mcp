 ...
 *
 * O PROBLEMA. Toda lista deste servidor cabe numa página só (15 tools, 3
 * resources, 0 templates, 3 prompts), então nenhuma resposta traz `nextCursor` e
 ...
 * endpoints nos dois transportes (medição de 30/08/2026: 133/148 no stdio,
 * 161/173 em produção).
 *
 ...
 * a mensagem entra: o POST do Worker (worker/src/index.ts) e o transporte stdio
 * (src/index.ts). O predicado é o mesmo nos dois — este módulo.
 *
 ...
 *
 * Transplantado de ilo-mcp-server/src/pagination.ts, a implementação de
 * referência do portfólio para os achados do mcpscore.
 */
